            ...
            <div class="col-md-9">
                <div class="card p-4 mt-3">
                    ...
                    <div class="d-flex justify-content-center px-5">
                        <div class="search">
                            <form method="POST" action="{{ route('search') }}">
                                @csrf
                                <input type="text" class="search-input" placeholder="Search for an artist or album..."
                    ...
                    <div class="row mt-4 g-1 px-4 mb-5">
                        ...
                        <div class="col-md-2">
                            <div class="card-inner p-3 d-flex flex-column align-items-center">
                                <img src="{{ asset('images/83819107-live-music-concert-icon-vector-illustration-design-graphic.webp') }}"
                                    width="50">
                                <div class="text-center mg-text">
                    ...
                    <div class="mb-4"><a href="{{ route('google-auth') }}"
                            class="form-control btn btn-outline-danger btn-block"><i class="fa fa-google"></i> Google
                            Login/Register </a><br></div>
                </div>
            </div>
        </div>
    </div>
