                        ...
                        @if ($favalbums > 0)
                            @if (in_array($result['name'], $favartists))
                                ...
                                <span class="fa fa-heart liked-icon" title="LIKED"
                                    onclick="unFavArtist('{{ $result['name'] }}')"></span>
                            @else
                                <span class="fa fa-heart like-icon" onclick="myFavArtist('{{ $result['name'] }}')"
                                    title="LIKE ME"></span>
                            @endif
                        @endif
                        <div class="card-body">
                            ...
                            <p class="card-text"><small class="text-muted">Streamable: {{ $result['streamable'] }}</small>
                            </p>
                        </div>
